...
function Vorpal(options) {
  if (!(this instanceof Vorpal)) {
    return new Vorpal(options);
  }
  ...
  this.cmdHistory = new this.CmdHistoryExtension(options.history);
  ...
  // Expose UI.
  this.ui = ui;
  this.ui._console = this._console
...
vorpal._hook = function (fn) {
  ...
  this._unhook = intercept(fn, this._console);
  this._hooked = true;
  return this;
};
